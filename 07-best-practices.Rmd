...
```{r, script-template, fig.cap="Example of dividing a script into sections", out.width="85%", out.extra=out_extra}
...
```{r, toc-side, fig.cap="Index at the top for section navigation", out.width="85%", out.extra=out_extra}
...
```{r, toc-bottom, fig.cap="Bottom menu for section navigation", out.width="85%", out.extra=out_extra}
...
```{r, section-closed, fig.cap="Compacting and expanding code sections", out.width="85%", out.extra=out_extra}
