...
```{r environment2, fig.cap="*Environment* - List of objects and variables present in the workspace", out.width="60%"}
...
```{r environment-empty, fig.cap="Empty *Environment* at the start of the working session", out.width="60%"}
...
```{r environment-object, fig.cap="*Environment* containing the created objects", out.width="60%"}
...
```{r, file-system, fig.cap="Computer organization (from Wikipedia)", out.width="35%"}
...
```{r, current-wd, fig.cap="Working directory of the current working session", out.width="95%"}
...
```{r, current-folder, fig.cap="Working directory of the current working session", out.width="65%"}
...
```{r, set-wd, fig.cap="Setting the working directory", out.width="95%"}
...
```{r, packages-process, fig.cap="Using the R packages", out.width="95%"}
...
```{r, packages-install, fig.cap="Installing packages via the RStudio interface", out.width="65%"}
...
```{r, library-car, fig.cap="The car packages is now available in the library", out.width="65%"}
...
```{r, load-package, fig.cap="Loading a package in the working session", out.width="65%"}
...
```{r, library-version, fig.cap="Updating packages", out.width="65%"}
...
```{r, library-remove, fig.cap="Removing packages", out.width="65%"}
...
```{r, package-documentation, fig.cap="Documentation of the 'car' package", out.width="65%"}
